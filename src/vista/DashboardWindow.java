...
public class DashboardWindow extends JFrame {
    ...
    public DashboardWindow(Usuario usuario, IProductoDAO pDAO, ICategoriaDAO cDAO, 
    ...
    private void setupLayout() {
        ...
        new controlador.EntradasController(panelEntradas, this.entradaDAO, this.productoDAO, this.proveedorDAO, this.categoriaDAO, this.notifier);
        panelContent.add(panelEntradas, "entradas");
        
        vista.ProveedoresPanel panelProveedores = new vista.ProveedoresPanel();
        new controlador.ProveedoresController(panelProveedores, this.proveedorDAO, this.usuario, this.notifier);
        panelContent.add(panelProveedores, "proveedores");
        
        vista.ClientesPanel panelClientes = new vista.ClientesPanel();
        new controlador.ClientesController(panelClientes, this.clienteDAO, this.usuario, this.notifier);
